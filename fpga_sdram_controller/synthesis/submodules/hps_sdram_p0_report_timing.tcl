...
foreach inst $instances {
	...
	write_timing_report
		...
		post_message -type critical_warning "Timing analysis was performed on core ${::GLOBAL_hps_sdram_p0_corename} using Quartus II v13.0 SP1 with a preliminary timing model and constraints. You must regenerate this IP in a future version of Quartus II to update the timing constraints to match the timing model."
	incr inst_id
}
